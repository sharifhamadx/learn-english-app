      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div className="space-y-6 text-left rtl:text-right">
          ...
          <nav className="flex flex-col gap-3 text-muted-foreground">
            <Link href="/about" className="hover:text-primary transition-all hover:translate-x-[5px] rtl:hover:translate-x-[-5px]">{t.footer.story}</Link>
            <Link href="/grammar" className="hover:text-primary transition-all hover:translate-x-[5px] rtl:hover:translate-x-[-5px]">{t.nav.grammar}</Link>
            <Link href="/lessons" className="hover:text-primary transition-all hover:translate-x-[5px] rtl:hover:translate-x-[-5px]">{t.footer.browse}</Link>
            <Link href="/login" className="hover:text-primary transition-all hover:translate-x-[5px] rtl:hover:translate-x-[-5px]">{t.footer.activate}</Link>
          </nav>
        </div>
